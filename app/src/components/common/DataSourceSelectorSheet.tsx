  ...
  return (
    ...
    >
      <div className="px-5 pt-2 pb-4">
        ...
        {/* Personal KBs */}
        <p className="text-[13px] font-semibold text-ink-primary pb-2">个人知识库</p>
        ...
        {/* Subscribed KBs */}
        <p className="text-[13px] font-semibold text-ink-primary pb-2">订阅知识库</p>
        <div className="space-y-2 mb-5">
