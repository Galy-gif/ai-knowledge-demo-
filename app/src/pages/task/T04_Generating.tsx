        ...
        <div className="text-center">
          ...
          {selectedKbNames.length > 0 && (
            <p className="text-caption text-ink-placeholder mt-2">
              基于 {selectedKbNames.length === 1 ? selectedKbNames[0] : `${selectedKbNames.length} 个资料包`}
            </p>
          )}
        </div>
