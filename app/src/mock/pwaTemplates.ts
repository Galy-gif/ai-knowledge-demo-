...
export const pwaTemplates: PwaTemplate[] = [
  {
    ...
    coreFeatures: '个股追踪、财报日历、兴趣库内研报关联',
    requirement: '帮我生成一个自选股看板，支持个股追踪、财报日历和兴趣库内研报关联。',
  ...
  },
  {
    ...
    icon: '🛋️',
    name: '沙发影院',
    description: '稍后观看与片单管理',
    coreFeatures: '片单收藏、追更提醒、评分记录',
    requirement: '帮我做一个追剧片单应用，记录想看的剧、追更进度和个人评分',
    keywords: ['追剧', '片单', '影视', '娱乐', '评分', '进度', '剧集', '电影'],
    targetRuntimeType: 'watchlist',
    resultAppName: '沙发影院',
    resultAppId: 'app_watchlist',
    resultMainColor: 'orange',
    defaultFeatures: ['片单收藏', '追更提醒', '评分记录'],
  ...
  },
  {
    ...
    icon: '📚',
    name: '我的阅读书架',
    description: '稍后读与阅读进度管理',
    coreFeatures: '稍后读清单、阅读进度、每日推荐',
    requirement: '帮我做一个阅读书架应用，管理稍后读清单、跟踪阅读进度、每天推荐该读什么',
    keywords: ['阅读', '稍后读', '书架', '文章', '进度', '推荐'],
    targetRuntimeType: 'reading_shelf',
    resultAppName: '我的阅读书架',
    resultAppId: 'app_reading',
    resultMainColor: 'orange',
    defaultFeatures: ['稍后读清单', '阅读燃尽', '每日推荐'],
    defaultAccessMode: 'desktop',
  },
  {
    id: 'doc-pack',
    ...
    icon: '🤖',
    name: 'AI Agent 资料包',
    description: '多标签资料聚合与整理',
    coreFeatures: '多标签聚合、主题归类、处理进度',
    requirement: '帮我把浏览器多个标签页和收藏的资料聚合成一个主题资料包，自动归类并跟踪处理进度',
    keywords: ['资料', '聚合', '标签', '整理', '归类', 'Agent'],
    targetRuntimeType: 'doc_pack',
    resultAppName: 'AI Agent 资料包',
    resultAppId: 'app_docpack',
    resultMainColor: 'orange',
    defaultFeatures: ['多标签聚合', '主题归类', '处理进度'],
    defaultAccessMode: 'desktop',
  },
  {
    id: 'fitness-planner',
