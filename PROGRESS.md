...
- 来源网格：3 组（收藏自浏览器 / 跨端导入 / 设备来源），每组 2-3 项，点开进二级列表
- 「我的速记」特有：设备来源组里有「新建速记」按钮
...
| K06 | 添加内容 BottomSheet | 粘贴链接、快捷卡多选、来源网格 7 种来源 |
| K07 | 上传中 | 3 文件进度动画 |
...
| K06 重构（自动同步/手动添加分组） | 中 | 已有完整 spec，上次中断；用户说暂缓 |
